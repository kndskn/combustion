# file: average_over_azimuthal_angle_3d_unstructured_data_and_export_\
# structured_data_for_matplotlib.py
import numpy as np
...
from download_data_from_paraview import *
...
output_file = input_file.replace('.csv', '') + '_average_data_to_2d_matplotlib' + '.tsv'

np.savetxt(output_file, array_to_export, fmt='% .8e',
           delimiter='\t',
