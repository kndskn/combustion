...
def write_points_and_made_plot(inp_array, LES_mean, EXP_mean, LES_rms, EXP_rms, MODEL, limits_mean, limits_rms, name):
    ...
    if LES_mean:
        ...
        ax.plot(r, w_r, color='green', marker='o', ms=10, mfc='w', mew=0.5, linewidth=10, label='LES axial')
        ax.plot(r, u_r, color='black', marker='o', ms=10, mfc='w', mew=0.5, linewidth=10, label='LES radial')

    if EXP_mean:
        ax.plot(r_exp_w1, w_exp1, color='red', marker='o', linewidth=10, linestyle=':', label='EXP tangential')
        ax.plot(r_exp_w2, w_exp2, color='red', marker='o', linewidth=10, linestyle=':')

        ax.plot(r_exp1, u_exp1, color='green', marker='o', linewidth=10, linestyle=':', label='EXP axial')
        ax.plot(r_exp2, u_exp2, color='green', marker='o', linewidth=10, linestyle=':')

        ax.plot(r_exp1, v_exp1, color='black', marker='o', linewidth=10, linestyle=':', label='EXP radial')
    ...
    if LES_rms:
        ...
        ax.plot(r, ww_r, color='green', marker='o', ms=10, mfc='w', mew=0.5, linewidth=10, label='LES RMS axial')
        ax.plot(r, uu_r, color='black', marker='o', ms=10, mfc='w', mew=0.5, linewidth=10, label='LES RMS radial')

    if EXP_rms:
        ax.plot(r_exp_w1, ww_exp1, color='red', marker='o', linewidth=10, linestyle=':', label='EXP RMS tangential')
        ax.plot(r_exp_w2, ww_exp2, color='red', marker='o', linewidth=10, linestyle=':')
        ...
        ax.plot(r_exp1, vv_exp1, color='black', marker='o', linewidth=10, linestyle=':', label='EXP RMS radial')
        ax.plot(r_exp2, vv_exp2, color='black', marker='o', linewidth=10, linestyle=':')
